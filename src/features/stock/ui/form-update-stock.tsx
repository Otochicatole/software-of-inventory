...
import { updateProduct } from "@/core/services/http/products/update.product";
import { Product } from "@/core/types/product";

interface FormUpdateStockProps {
    product: Product;
    onSuccess?: (product: Product) => void;
}

export default function FormUpdateStock({ product, onSuccess }: FormUpdateStockProps) {
